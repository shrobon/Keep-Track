...
#handler for the tasks screen
@app.route('/tasks/')
@login_required
def tasks():
	g.db = connect_db() #supplied by some imports 
	cur = g.db.execute(
	...
	#now send the page this information and ask it to display them
	# AddTaskForm() is a name of a form used to add tasks 
	return render_template(
		'tasks.html',
		form = AddTaskForm(request.form), #notice this
